                ...
                <div className="col-span-12 md:col-span-8 space-y-2.5">
                  ...
                  <div className=" md:mr-12 xl:mr-16">
                    ...
                    <p className="text-gray-lite  dark:text-color-910 leading-7">
                      i am a fullstack developer with a year of exepriance,
                      specializing in ReactJS, i have a great experiance in
                      developing and deploying websites utilizing various
                      open-source packages as well as content managment syste
                      (CMS) such as SANITY.
                    </p>
                    <p className="text-gray-lite leading-7 mt-2.5 dark:text-color-910">
                      i have extensive experiance in HTML, CSS, JavaScript and
                      various open source frameworks Such as NodeJs, ExpressJS,
                      Sanity, React, i am skilled in the use of these frameworks
                      to develop web applications based on Single Page
                      Applications(SPA) architecures.
                    </p>
                  </div>
